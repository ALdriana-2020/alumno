...
function insertar_estudiante($pCedula_estudiante,$pNombre_estudiante,$pCorreo_estudiante,$pCelular_estudiante,$pFecha_estudiante)
{
    ...
    $obj = new conexion;
    $conex = $obj -> conectar();
    $sql= "INSERT INTO `alumno` (`Cedula_estudiante`, `Nombre_estudiante`, `Correo_estudiante`, `Celular_estudiante`, `Fecha_estudiante`) VALUES ('$pCedula_estudiante', '$pNombre_estudiante', '$pCorreo_estudiante', '$pCelular_estudiante', '$pFecha_estudiante');";
    ...
    if($ejecutar)
 {
    $msj="Registro de forma correcta"; 
         ...
         echo"has tenido el siguiente error ; <br /> " . msyqli_error();
     }
